...
(1, '妙語說書人', 'item_20210514040620.jpg', 1480, 5, 8, '2021-05-10 15:12:48', '2021-05-14 10:06:20', '屏氣凝神！插圖即將掀開了！ 這些插圖都圍繞著一個主題：一段令人費解的句子。但是，這段句子實際上是源於這五張插圖之一，到底是哪一張呢？ 你要利用天生的才華以及直覺來找到它，同時也要躲開其他玩家所設下的陷阱。  Dixit是一款令人感到驚奇、歡樂以及興奮的遊戲，適合讓你與你的家人以及朋友們一起遊戲。'),
...
--
ALTER TABLE `items`
  MODIFY `itemId` int(11) NOT NULL AUTO_INCREMENT COMMENT '流水號', AUTO_INCREMENT=19;
COMMIT;
