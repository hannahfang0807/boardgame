            ...
            <table class="border">
                ...
                WHERE `itemId` = ? ";
                    ...
                    ?>
                        <tr>
                            <td class="border">
                                <input style="width:100px" type="text" name="itemName" value="<?php echo $arr[0]['itemName']; ?>" maxlength="100" />
                            </td>
                            <td class="border">
                            ...
                            <td class="border">
                                <input style="width:100px" type="text" name="itemPrice" value="<?php echo $arr[0]['itemPrice']; ?>" maxlength="11" />
                            </td>
                            <td class="border">
                                <input style="width:100px" type="text" name="itemQty" value="<?php echo $arr[0]['itemQty']; ?>" maxlength="3" />
                            </td>
                            <td class="border">
                            ...
                            <td class="border">
                                <input style="width:300px" type="text" name="itemDescription" value="<?php echo $arr[0]['itemDescription']; ?>" maxlength="1000" />
                            </td>
                        </tr>
                    <?php
                    } else {
                ...
                <tfoot>
                    <tr>
                        <td class="border" colspan="8"><input type="submit" name="smb" value="更新"></td>
                    </tr>
                    </tfoo>
            </table>
